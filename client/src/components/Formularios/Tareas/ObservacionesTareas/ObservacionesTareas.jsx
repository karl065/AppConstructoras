...
import {observacionesTareas} from '../../../../redux/Actions/ActionsTareas/ActionsTareas';

const ObservacionesTareas = ({
  idActualizar,
  setModalObservacion,
  nombreTarea,
}) => {
  ...
  const formik = useFormik({
    initialValues: {
      idTareas: idActualizar,
      observacion: '',
    },
    validationSchema: validationSchema,
    onSubmit: (values, {resetForm}) => {
      observacionesTareas(values);
      resetForm();
...
export default ObservacionesTareas;
